...
import org.shaastra.qmshelper.JSONParser;
import org.shaastra.qmshelper.NewUser;
...
public class Choose extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String[] choices = { "Scan and Register", //"Get list from server",
				"Refresh Event List", "Show scanned data", "Export to csv and send"//,"Send exported csv"
				};
...
//						break;
	...
	class getEvents extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(Choose.this);
		...
		protected void onPostExecute(String file_url) {
			...
			if(error==1){
				TextView msg = new TextView(Choose.this);
				msg.setText(Html.fromHtml(errmsg));
				msg.setTextSize(16);
				msg.setTextColor(Color.GRAY);
				msg.setMovementMethod(LinkMovementMethod.getInstance());
				AlertDialog.Builder builder1 = new AlertDialog.Builder(Choose.this);
